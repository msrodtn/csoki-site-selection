 ...
 * Currently supports Iowa with color-coded road segments.
 */
...
// Available states (expand as we add more)
const AVAILABLE_STATES = [
  { code: 'IA', name: 'Iowa', serviceUrl: 'https://services.arcgis.com/8lRhdTsQyJpO52F1/arcgis/rest/services/Traffic_Data_view/FeatureServer/10' },
  // Future states:
  // { code: 'NE', name: 'Nebraska', serviceUrl: '...' },
  // { code: 'NV', name: 'Nevada', serviceUrl: '...' },
];
